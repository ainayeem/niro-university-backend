...
const deleteSemesterRegistrationFromDB = async (id: string) => {
  ...
  **/
  ...
  if (!isSemesterRegistrationExists) {
    throw new AppError(StatusCodes.NOT_FOUND, "This registered semester is not found !");
  }
  ...
  if (semesterRegistrationStatus !== "UPCOMING") {
    throw new AppError(StatusCodes.BAD_REQUEST, `You can not update as the registered semester is ${semesterRegistrationStatus}`);
  }
